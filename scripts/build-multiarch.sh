...
# Usage: ./build-multiarch.sh [service-name] [version]
...
#   Examples:
#     ./build-multiarch.sh                    # Build all services with "latest"
#     ./build-multiarch.sh frontend           # Build frontend with "latest"
#     ./build-multiarch.sh frontend v1.0.0    # Build frontend with "v1.0.0"
#     ./build-multiarch.sh v1.0.0             # Build all services with "v1.0.0"
